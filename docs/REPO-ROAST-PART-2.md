...
5. **No measurement framework.** Which KPIs matter? How often reviewed? What triggers a pivot? The docs/MASTER-TODO-RESTANTE.md has "Metrics a seguir" section but it is not connected to the actual plan execution.
