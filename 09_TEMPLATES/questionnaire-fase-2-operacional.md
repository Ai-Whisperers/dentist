...
## 📦 BLOQUE C2 — Testimonios (5 preguntas)
...
## 📦 BLOQUE C3 — Contenido de redes (5 preguntas)
...
## 📦 BLOQUE C4 — Integraciones y operaciones (5 preguntas)
...
## 📋 Resumen de los 20 datos

| # | Dato | Bloque | Urgencia |
|---|------|--------|----------|
| 1 | Fotos tuyas con scrubs | C1 | 🟡 importante |
| 2 | Tipo de foto (cuerpo/busto) | C1 | 🟡 importante |
| 3 | Fotos del consultorio | C1 | 🟡 importante |
| 4 | Fotos con pacientes | C1 | 🟢 nice-to-have |
| 5 | Antes/después de casos | C1 | 🟡 importante |
| 6 | Pacientes para testimonio escrito | C2 | 🟡 importante |
| 7 | Pacientes para testimonio en video | C2 | 🟢 nice-to-have |
| 8 | Foto del paciente o anónimo | C2 | 🟡 importante |
| 9 | Testimonios en inglés | C2 | 🟢 nice-to-have |
| 10 | Consentimientos firmados | C2 | 🔴 bloqueante para publicar |
| 11 | Facebook activo | C3 | 🟡 importante |
| 12 | Instagram | C3 | 🟢 opcional |
| 13 | Blog | C3 | 🟢 opcional |
| 14 | LinkedIn | C3 | 🟢 opcional |
| 15 | Newsletter | C3 | 🟢 opcional |
| 16 | Pagopar | C4 | 🟡 importante |
| 17 | Bancard POS | C4 | 🟡 importante |
| 18 | Agenda online | C4 | 🟢 opcional |
| 19 | Google Analytics | C4 | 🟢 nice-to-have |
| 20 | Formulario de contacto | C4 | 🟢 opcional |

---

## 🎁 Lo que NO te pregunto (no es operacional)

- ❌ Nada sobre tu situación con O3
- ❌ Nada legal/conflictivo
- ❌ Nada personal/familiar
- ❌ Nada de marca/identidad visual (eso se decidió con "Ometz Dental" + "Te escucho.")

---

## ⏭️ Qué viene después

Una vez que tengas los 20 datos:

1. **Sitio web completo al 100%** con fotos reales, testimonios, servicios
2. **Redes activas** con contenido pre-armado (3-6 posts listos)
3. **Operación 100% digital**: agenda online, pagos configurados, formulario
4. **Programa de referidos activo**: 1 paciente referido por semana
5. **Métricas claras**: cuántas visitas, cuántos leads, cuántos pacientes
